...
class HyperNet(nn.Module):
    ...
    def __init__(self, lda_out_channels=16, hyper_in_channels=112, target_in_size=224, target_fc1_size=112, target_fc2_size=56, target_fc3_size=28, target_fc4_size=14, feature_size=7):
        ...
        self.bbone = resnet50_backbone(lda_out_channels, target_in_size, pretrained=False)
...
class ResNetBackbone(nn.Module):
    ...
    def __init__(self, lda_out_channels, in_chn, block, layers, num_classes=1000):
        ...
        self.lda4_pool = nn.AvgPool2d(12, stride=12)
...
def weights_init_xavier(m):
    ...
    if classname.find('Conv') != -1:
        ...
        init.uniform_(m.weight.data, .02, 1.)
