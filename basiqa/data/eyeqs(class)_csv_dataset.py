...
class EyeQSClassDataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(EyeQSClassDataset, self).__init__()
        self.opt = opt
        ...
        if self.augment_ratio is not None:
          ...
          for times in range(0,self.augment_ratio):
            ...
            new_level_list.extend(self.lvs)
          self.image_names=new_image_list
          self.lvs=new_level_list
    ...
    def __getitem__(self, index):
        ...
        return {'image': img_data, 'quality': lv, 'img_path': img_path}
